...
export default function Clients() {
    ...
    return (
        <section
            id="clients"
            className="flex bg-[#045B64] flex-col items-center justify-center h-[270px]"
        >
            <div className="max-w-[1342px] w-full flex flex-col md:flex-row gap-6 mx-auto my-[226.86px] w-full items-center">
                <h1
                    className={
                        spaceGrotesk.className +
                        " text-white text-[24px] lg:text-[40px] font-medium lg:text-nowrap text-center md:pl-[50px] text0cent md:text-left "
                    }
                >
                    Clientes que
                    <br />
                            ...
                            {clientLogos.map((logo, index) => (
                                <MarqueeItem key={index}>
                                    <Image
                                        ...
                                        className="overflow-hidden w-[150px] lg:w-[180px] object-cover mx-4"
                                        src={logo}
                                    />
                                </MarqueeItem>
                            ))}
